...
```typst
#import "@preview/json-resume:0.2.0": validate-resume, coerce-resume, parse-resume // x-release-please-version
```
...
```typst
#import "@preview/json-resume:0.2.0": parse-resume // x-release-please-version
...
```typst
#import "@preview/json-resume:0.2.0": validate-resume, coerce-resume // x-release-please-version
